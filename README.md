...
- 可選擇本機 Ollama 的 Qwen 3 `qwen3:4b` 或 `qwen3:8b`，依 [通用逐字稿整理規範](desktop-app/prompts/course-transcript-notes.md) 產生各主題重點、時間戳、全課摘要與複習問題；不使用固定科目模板。8B 較慢，也不能保證修正逐字稿錯字
...
1. 開啟 `desktop-app/release/win-unpacked/CourseScribe.exe`，或使用已安裝的同版本程式。
